...
[hamburburmod(                "US Region", "Makes you join the region for US", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class USRegion : hamburburmod
{
    protected override void Pressed() => ConnectToRegion("us");
