...
{
    private const string BoxGUID = "fhgadhfjbvsaougwfjsdgjydsvyawuiegfdsck";

    private readonly Dictionary<VRRig, Renderer> boxes = new();

    private readonly Vector3 boxScale = new(0.3f, 0.4f, 0.3f);
    ...
    private void CreateBox(VRRig rig)
    {
        ...
        if (box.TryGetComponent(out Renderer renderer))
        {
            ...
            renderer.material.color  = new Color(boxColor.r, boxColor.g, boxColor.b, 0.4f);
            boxes[rig]               = renderer;
        }
