...
public class MecchaSelectForest : MecchaSelectMap { protected override int Map => 1; }

[hamburburmod("Select City", "Selects City on the round board", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class MecchaSelectCity : MecchaSelectMap { protected override int Map => 2; }

[hamburburmod("Select Colorful Cubes", "Selects Colorful Cubes on the round board", ButtonType.Fixed,
        AccessSetting.Public, EnabledType.Disabled, 0)]
public class MecchaSelectCubes : MecchaSelectMap { protected override int Map => 3; }

[hamburburmod("Select Random Map", "Selects Random on the round board", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class MecchaSelectRandom : MecchaSelectMap { protected override int Map => 99; }
...
[hamburburmod("Start Forest Round", "Starts a round on Forest", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class MecchaStartForest : MecchaStartMap { protected override int Map => 1; }

[hamburburmod("Start City Round", "Starts a round on City", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class MecchaStartCity : MecchaStartMap { protected override int Map => 2; }

[hamburburmod("Start Cubes Round", "Starts a round on Colorful Cubes", ButtonType.Fixed, AccessSetting.Public,
        EnabledType.Disabled, 0)]
public class MecchaStartCubes : MecchaStartMap { protected override int Map => 3; }

[hamburburmod("Start Random Round", "Starts a round on a random non-sentinel map", ButtonType.Fixed,
        AccessSetting.Public, EnabledType.Disabled, 0)]
public class MecchaStartRandom : MecchaStartMap { protected override int Map => 99; }
...
[hamburburmod("Teleport Lobby", "Teleports to Meccha Gorilla's lobby point", ButtonType.Fixed,
        AccessSetting.Public, EnabledType.Disabled, 0)]
public class MecchaTeleportLobby : MecchaTeleport { protected override string PointName => "LobbyTeleportPointEMPTY"; }

[hamburburmod("Teleport Forest", "Teleports to the Forest round point", ButtonType.Fixed,
        AccessSetting.Public, EnabledType.Disabled, 0)]
public class MecchaTeleportForest : MecchaTeleport { protected override string PointName => "ForestMapTeleportPointEMPTY"; }

[hamburburmod("Teleport City", "Teleports to the City round point", ButtonType.Fixed,
        AccessSetting.Public, EnabledType.Disabled, 0)]
public class MecchaTeleportCity : MecchaTeleport { protected override string PointName => "CityMapTeleportPointEMPTY"; }
