...
namespace hamburbur.Managers.DiscordRPC.RPC;
...
#pragma warning disable CS0618
                    // We know ConnectedPipe is obsolete, but we still need to use it for the ConnectionEstablishedMessage
...
#region Privates
    ...
    private readonly object          l_rtqueue = new(); //Lock for the send queue
    private readonly uint            _maxRtQueueSize;
    private readonly Queue<ICommand> _rtqueue; //The send queue

    private readonly object          l_rxqueue = new(); //Lock for the receive queue
    ...
    private readonly AutoResetEvent queueUpdatedEvent = new(false);
