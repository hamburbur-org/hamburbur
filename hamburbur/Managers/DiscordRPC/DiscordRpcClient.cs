...
using hamburbur.Managers.DiscordRPC.Events;
using hamburbur.Managers.DiscordRPC.Exceptions;
using hamburbur.Managers.DiscordRPC.IO;
using hamburbur.Managers.DiscordRPC.Logging;
using hamburbur.Managers.DiscordRPC.Message;
using hamburbur.Managers.DiscordRPC.RPC;
using hamburbur.Managers.DiscordRPC.RPC.Commands;
...
#region Initialization
    ...
    /// <summary>
    ///     Creates a new Discord RPC Client which can be used to send Rich Presence and receive Join events. This constructor
    ///     exposes more advance features such as custom NamedPipeClients and Loggers.
    /// </summary>
    /// <param name="applicationID">The ID of the application created at discord's developers portal.</param>
    /// <param name="pipe">
...
#region Updates
    ...
    /// <summary>
    ///     Updates only the <see cref="BaseRichPresence.Type" /> of the <see cref="CurrentPresence" /> and sends the updated
    ...
    /// <summary>
    ///     Updates only the <see cref="BaseRichPresence.StatusDisplay" /> of the <see cref="CurrentPresence" /> and sends the
    ...
    public RichPresence UpdatePartySize(int size) => Update(p =>
                                                            {
                                                                ...
                                                                if (p.Party == null)
                                                                    throw new BadPresenceException(
                                                                            "Cannot set the size of the party if the party does not exist");
