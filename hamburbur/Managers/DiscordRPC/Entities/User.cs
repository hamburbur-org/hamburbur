...
public class User
{
	...
	/// </summary>
	/// <remarks>
	///     If the user has a default Discord avatar, this value will be <c>null</c>.
	///     <see cref="GetAvatarURL(AvatarFormat, AvatarSize)" /> will still return the correct default avatar.
	/// </remarks>
	[JsonProperty("avatar")]
...
#pragma warning restore CS0618
        ...
        return string.Format("https://{0}{1}{2}?size={3}&animated=true", CdnEndpoint, endpoint,
                GetAvatarExtension(format), (int)size);
    }
	...
	public string GetAvatarExtension(AvatarFormat format) => "." + format.ToString().ToLowerInvariant();
