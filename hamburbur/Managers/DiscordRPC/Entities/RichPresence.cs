...
using hamburbur.Managers.DiscordRPC.Helper;
...
public class BaseRichPresence
{
    ...
    /// <summary>
    ///     The secrets used for Joining. Secrets are obfuscated data of your choosing. They could be match ids, player ids,
    ///     lobby ids, etc. Make this object null if you do not wish too / unable too implement the Join / Request feature.
    ///     <para>
    ...
    internal static bool ValidateString(string   str, out string result, bool useBytes, int length,
                                 ...
                                 : new Assets
                                 {
                                         LargeImageKey =
                                                 Assets.LargeImageKey != null
                                                         ? Assets.LargeImageKey.Clone() as string
                                                         : null,
                                         LargeImageText =
                                                 Assets.LargeImageText != null
                                                         ? Assets.LargeImageText.Clone() as string
                                                         : null,
                                         LargeImageUrl =
                                                 Assets.LargeImageUrl != null
                                                         ? Assets.LargeImageUrl.Clone() as string
                                                         : null,
                                         SmallImageKey =
                                                 Assets.SmallImageKey != null
                                                         ? Assets.SmallImageKey.Clone() as string
                                                         : null,
                                         SmallImageText =
                                                 Assets.SmallImageText != null
                                                         ? Assets.SmallImageText.Clone() as string
                                                         : null,
                                         SmallImageUrl =
                                                 Assets.SmallImageUrl != null
                                                         ? Assets.SmallImageUrl.Clone() as string
                                                         : null,
                                 },
